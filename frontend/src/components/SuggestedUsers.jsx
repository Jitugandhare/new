...
const SuggestedUsers = () => {
  ...
  const [loadingIds, setLoadingIds] = useState([]); // array of user IDs being followed/unfollowed

  // Helper: check if logged-in user follows this suggested user
  ...
  const handleFollowToggle = async (targetUserId) => {
    ...
    if (loadingIds.includes(targetUserId)) return; // avoid multiple clicks
